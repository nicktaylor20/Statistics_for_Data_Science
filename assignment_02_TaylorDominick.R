...
## Use `setwd()` if needed
setwd("C:/Users/nickm/Documents/GitHub/dsc520")
##getwd()
...
voter_turnout_df1 <- read_excel('data/G04ResultsDetail2004-11-02.xls', 'Voter Turnout')
...
db <- dbConnect(drv = RSQLite::SQLite(), "data/tidynomicon/example.db") 
